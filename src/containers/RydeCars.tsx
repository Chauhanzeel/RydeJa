...
import {
  ownerCarListLuxStart,
  ownerCarListStart,
  ownerCarViewStart,
} from "../actions/carOwnerActions";
import { Colors, FontSize, Measures } from "../Theme/variables";
import { getOr } from "../constants/constants";
import { carListLux } from "../saga/customerSaga";
...
const LuxuryCars: React.FC<FilterModalProps> = ({ route }) => {
  ...
  const listFooterComponent = () =>
    _.get(carListData, "totalCount", null) > _.size(dataList) ||
    _.get(ownerCarListData, "totalCount", null) > _.size(dataList) ? (
