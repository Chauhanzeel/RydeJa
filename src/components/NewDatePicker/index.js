        ...
        >
          <Text
            style={[
              ...
              calendarHeaderTextStyles,
              sharedTextStyles,
              { fontFamily: FontStyle.urbanistMedium.fontFamily },
            ]}
          >
...
const styles = StyleSheet.create({
  ...
  calendarArrow: (direction) => ({
    tintColor: "white",
    transform: [
      { rotate: direction === "left" ? "360deg" : "180deg" },
      { scale: 0.4 },
    ],
  }),
  ...
  monthYear: (isSelected, isDisabled, selectedStyles) => ({
    backgroundColor: isDisabled || !isSelected ? "#ffffff" : Colors.yellow,
    fontFamily: FontStyle.urbanistMedium,
    borderRadius: 10,
